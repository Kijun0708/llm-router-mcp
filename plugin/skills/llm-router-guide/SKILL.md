...
| "비교/A vs B/뭐가 나을까/장단점" | `ensemble-debate` (auto_debate) | 예 |
...
| "A안이랑 B안 중에..." | ensemble-debate | "전문가 토론으로 비교할까요?" |
...
| 상황 | 제안 스킬 | 제안 방식 |
|------|----------|----------|
| 구현 중 기술 선택지를 만남 | ensemble-debate | "전문가 토론으로 비교할까요?" |
...
5. "비교" → `ensemble-debate` 우선 (research-topic보다)
